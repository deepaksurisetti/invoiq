...
const DEFAULT_STATE = {
  ...
  paymentTerms: 'Net 30',
  currency: 'USD',
  from: { name:'', email:'', phone:'', address:'', city:'', state:'', zip:'', country:'', logo: null },
  to:   { name:'', email:'', phone:'', address:'', city:'', state:'', zip:'', country:'' },
...
export default function App() {
  ...
  function updateField(path, value) {
    ...
    setData(prev => {
      ...
      else if (parts.length === 2) next[parts[0]] = { ...prev[parts[0]], [parts[1]]: value }
      else if (parts.length === 3) next[parts[0]] = {
        ...prev[parts[0]],
  ...
  function handleTypeChange(newType) {
    ...
    setData(prev => ({ ...prev, type: newType, number: `${prefix}-001` }))
  }
  ...
  return (
    // Apply Tailwind dark-mode class at root — all dark: variants activate here
